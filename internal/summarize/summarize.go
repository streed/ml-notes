...
func (s *Summarizer) callOllama(prompt string) (string, error) {
	...
	// Clean the response to remove thinking tags and trim whitespace
	cleanedResponse := cleanThinkingTags(result.Response)
...
// cleanThinkingTags removes <think> and </think> tags from the response
// These tags might be generated by some LLMs for internal reasoning
// but should not be shown to the end user
func cleanThinkingTags(text string) string {
	// Use regex to remove <think>...</think> blocks including their content
	...
	// Also remove any standalone <think> or </think> tags that might be left
